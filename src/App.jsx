...
export default function ERP(){
  ...
  const importarOrcSodero=()=>{
    const ambsBase=[
      {nome:"Cozinha",desc:"Cozinha integrada com ilha central.\n\nARMÁRIOS SUPERIORES:\n3300x900x450mm + 800x500x450mm (em cima da geladeira) em MDF Freijó Guararapes 18mm — portas de abrir lisas, frentes mimetizadas, dobradiças com amortecimento.\nIluminação em LED.\nPuxador cava na madeira.\n\nGABINETE INFERIOR:\n1500x720x650mm + 630x720x650mm em MDF Gianduia Trama Duratex 18mm — composição com gavetas (4 frentes em coluna), portas de abrir, nicho para lava-louças e espaçamento para máquina de lavar.\nPuxador cava na madeira.\n\nILHA CENTRAL:\n2150x670x720mm em MDF Gianduia 18mm com 2 gavetas e 1 gavetão, fechamento para forno embutido.\nRevestimento frontal.\nNichos decorativos na lateral.\nInterior em MDF Branco TX 15mm.\nPuxador cava na madeira.\n\nARMÁRIO BAR:\n100x720x400mm (inferior) em MDF Freijó Guararapes 18mm.\nArmário com portas de abrir.\nPrateleira interna.\nPuxador cava na madeira.\n\nBancada e ilha em Granito Preto São Gabriel.\nFundos em MDF Gianduia/Freijó 06mm.\nInterior em MDF Branco TX 15mm."},
      {nome:"Cozinha — Prateleiras",desc:"Conjunto de prateleiras superiores + cristaleira suspensa.\n\nPRATELEIRAS SUPERIORES:\n3 prateleiras em MDF Freijó Guararapes 18mm — 1000x40x300mm cada.\nFixação oculta por grapas.\n\nCRISTALEIRA SUSPENSA:\nMódulo suspenso 700x1140x300mm em MDF Gianduia Trama Duratex 18mm.\nPortas com vidro temperado incolor e moldura em MDF.\nFundo revestido em espelho.\nPrateleiras internas em vidro temperado.\nIluminação em LED."},
      {nome:"Varanda Gourmet",desc:"Marcenaria completa para varanda gourmet integrada à cozinha.\n\nARMÁRIOS INFERIORES:\nGabinete inferior 1700x700x650mm em MDF Gianduia Trama Duratex 18mm.\nComposição: 4 portas de giro + 2 gavetões + portas superiores ventiladas e fechamento para churrasqueira embutida.\nFrentes mimetizadas com puxador slim.\nFerragens com amortecimento.\n\nTORRE:\nColuna 850x2200x400mm em MDF Gianduia 18mm para utensílios e armazenagem.\nPortas de abrir lisas + prateleiras internas.\nInterior em MDF Branco TX 15mm.\n\nCACHEPOT:\n2 unidades 600x900x350mm em MDF Freijó Guararapes 18mm com pés em metalon (pintura eletrostática preto fosco).\n\nBANCADA:\nBancada em Granito Preto São Gabriel sobre o gabinete inferior.\nRecorte para churrasqueira embutida (compra cliente)."},
      {nome:"Sala de Estar — Painel TV e Rack",desc:"PAINEL DE TV:\nPainel de TV Frisado em L 3800x2450x40mm em MDF Freijó Guararapes 18mm na parede principal da sala.\nMontagem piso-teto com recorte central para TV e cabeamento embutido.\nIluminação indireta em LED contornando o painel.\n\nPRATELEIRA SUPERIOR:\n6250x350x40mm em MDF Freijó Guararapes 18mm com fixação oculta.\n\nRACK INFERIOR FLUTUANTE:\nRack suspenso 1900x400x350mm em MDF Gianduia Trama Duratex 18mm.\n2 gavetas com frente passante (sem puxador aparente).\nIluminação LED indireta sob o rack (efeito flutuante).\nFundo em MDF Gianduia 06mm.\nFerragens com amortecimento."},
      {nome:"Quarto — Costura e Visitas",desc:"Quarto multifuncional para costura e hospedagem.\n\nCAMA FUNCIONAL SOLTEIRO:\nCama de solteiro 850x350x1950mm em MDF Freijó Guararapes 18mm.\n3 gavetões inferiores para armazenagem com corrediças telescópicas.\nFundo em MDF Freijó 06mm.\n\nBAÚ CABECEIRA:\nBaú/painel cabeceira 850x800x500mm em MDF Freijó Guararapes 18mm com tampa basculante + pistão a gás e 2 gavetas.\n\nBANCADA DE COSTURA:\nBancada de trabalho 1870x400x500mm em MDF Freijó Guararapes 18mm.\nArmário embaixo da bancada com 1 porta de giro e prateleira interna — 600x780x600mm.\nPrateleiras abertas superiores em MDF Freijó 18mm — fixação oculta por grapas com perfil de LED embutido por baixo.\n3 prateleiras em L de 1230x40x300mm + 600x40x500mm e 1 de 600x40x500mm.\n\nARMÁRIO SUPERIOR:\nArmário com 1 porta de abrir e prateleira interna — 850x1150x320mm.\n\nGUARDA-ROUPA:\nArmário 1000x2550x600mm em MDF Gianduia Trama Duratex 18mm.\nDivisão clara entre área de roupas (cabideiro + gavetas internas + sapateira inferior) e área de costura (prateleiras + gavetas para acessórios).\nPrateleiras superiores para uso menos frequente.\nFundo em MDF Gianduia 06mm.\nInterior em MDF Branco TX 15mm.\nPuxador slim em alumínio."},
      {nome:"Quarto da Filha",desc:"Quarto feminino contemporâneo (casal).\n\nCAMA CASAL COM GAVETAS:\nCama de casal 1430x1930x350mm em MDF Freijó Guararapes 18mm.\nGavetões frontais (2 frentes em coluna).\n4 gavetas, 2 em cada lado.\n\nCABECEIRA EM MADEIRA:\nCabeceira 2800x1250x40mm em MDF Freijó Guararapes 18mm com perfil de LED embutido por trás (iluminação indireta).\nFixação em parede.\n\nCRIADOS-MUDOS (2 unidades):\nCriado-mudo 650x550x450mm em MDF Freijó Guararapes 18mm (estrutura) com frentes de gaveta em MDF Gianduia Trama Duratex 18mm.\n2 gavetas com frente passante.\nCorrediças telescópicas com amortecimento.\n\nGUARDA-ROUPA / CLOSET (3 portas de correr):\nArmário 2900x2460x600mm em MDF Gianduia Trama Duratex 18mm.\n3 portas de correr — 1 central espelhada + 2 laterais em acabamento Gianduia.\nTrilho superior embutido (sistema slim).\n\nINTERIOR DO CLOSET (em MDF Branco TX 15mm):\n3 cabideiros em alturas diferentes (0,95m / 1,05m / 1,20m) em tubo oblongo cromado.\nCabideiro lateral para roupas longas.\nGavetas internas — coluna esquerda (5 gavetas), coluna central (4 sapateiras) e coluna direita (4 gavetas).\nPrateleiras superiores para caixas e malas (alturas 0,25 / 0,30 / 0,57m).\nSapateira inferior com prateleiras.\nFundo em MDF Branco TX.\n\nPAINEL DE TV:\nPainel TV 1150x2460x40mm em MDF Freijó Guararapes 18mm — recorte para TV com cabeamento embutido.\nPrateleira horizontal 2050x40x250mm em MDF Gianduia Trama Duratex 18mm com fixação oculta por grapas."},
      {nome:"Suíte Casal",desc:"Suíte master com cama queen, cabeceira iluminada, criados-mudos com rodízios e armário com TV embutida.\n\nCAMA QUEEN COM GAVETAS:\nCama queen 1600x400x2000mm em MDF Freijó Guararapes 18mm.\nGavetões frontais (2 frentes em coluna).\n2 gavetões e 1 gaveta menor de cada lado.\nFundo em MDF Freijó 06mm.\n\nCABECEIRA EM FREIJÓ:\nPainel cabeceira 2800x1250x40mm em MDF Freijó Guararapes 18mm — fixação em parede com perfil de LED embutido na borda superior (iluminação indireta).\nPreparação para 2 arandelas articuladas fixadas na cabeceira (luminárias compra cliente).\n\nCRIADOS-MUDOS (2 unidades):\nCriado-mudo 530x400x500mm em MDF Freijó Guararapes 18mm com rodízios escondidos.\n2 gavetas + 1 nicho aberto inferior.\nCorrediças telescópicas com amortecimento.\nFrente passante com puxador cava.\n\nARMÁRIO 4 PORTAS DE CORRER COM TV:\nArmário planejado 3800x2560x600mm em MDF Gianduia Trama Duratex 18mm.\n4 portas de correr em Reflecta Bronze (efeito espelhado bronze) com perfil slim Bronze.\nTrilho superior embutido (sistema slim) — abertura suave com amortecimento.\nRecorte para TV fixada na 3ª porta (alinhada à cama) com cabeamento embutido.\n\nINTERIOR DO ARMÁRIO (em MDF Branco TX 15mm):\nCabideiros em diferentes alturas (1,05m e 1,95m) em tubo oblongo cromado para roupas curtas e longas.\nColuna esquerda — gaveteiro com 4 gavetas + sapateira inferior com 3 prateleiras.\nColunas centrais — cabideiros + gaveteiro com 5 gavetas (acessórios e roupas dobradas).\nColuna direita — gaveteiro com 3 gavetas + sapateira inferior + prateleiras superiores.\nPrateleiras superiores corridas para caixas e malas.\nFundo em MDF Gianduia 06mm.\n\nFERRAGENS: corrediças telescópicas, trilho de correr embutido com amortecimento."},
      {nome:"Banheiro Suíte",desc:"Banheiro da suíte com gabinete suspenso e espelheira planejada.\n\nGABINETE INFERIOR SUSPENSO:\nGabinete suspenso 800x700x500mm em MDF Gianduia.\n1 basculante e 1 gaveta com corrediças invisíveis e puxador cava.\nRecorte para cuba de sobrepor (cuba e torneira compra cliente).\nTampo em porcelanato/granito (à definir com cliente).\n\nESPELHEIRA SUSPENSA:\nArmário espelheira 800x900x150mm em MDF Gianduia com 3 portas espelhadas.\nPrateleiras internas em MDF Branco TX para armazenagem de itens de higiene.\nDobradiças em inox com amortecimento.\nFita de LED embutida na borda inferior (iluminação direta sobre a bancada).\nO LED se estende embaixo da prateleira também.\n\nPRATELEIRA DE APOIO:\nPrateleira lateral 600x400x150mm em MDF Branco TX com fixação oculta por grapas para apoio de plantas e decoração.\n\nFundo em MDF Branco TX.\nPuxador cava na madeira."},
      {nome:"Banheiro Social",desc:"Banheiro social com gabinete suspenso e espelheira planejada.\n\nGABINETE INFERIOR SUSPENSO:\nGabinete suspenso 800x700x500mm em MDF Gianduia.\n1 basculante e 1 gaveta com corrediças invisíveis e puxador cava.\nRecorte para cuba de sobrepor (cuba e torneira compra cliente).\nTampo em porcelanato/granito (à definir com cliente).\n\nESPELHEIRA SUSPENSA:\nArmário espelheira 800x900x150mm em MDF Gianduia com 3 portas espelhadas.\nPrateleiras internas em MDF Branco TX para armazenagem de itens de higiene.\nDobradiças em inox com amortecimento.\nFita de LED embutida na borda inferior (iluminação direta sobre a bancada).\nO LED se estende embaixo da prateleira também.\n\nPRATELEIRA DE APOIO:\nPrateleira lateral 600x400x150mm em MDF Branco TX com fixação oculta por grapas para apoio de plantas e decoração.\n\nFundo em MDF Branco TX.\nPuxador cava na madeira."},
    ];
  ...
  const atualizarSoderoCorrecoes=()=>{
    ...
    const correcoes={
      "Cozinha":{newName:"Cozinha",newDesc:"Cozinha integrada com ilha central.\n\nARMÁRIOS SUPERIORES:\n3300x900x450mm + 800x500x450mm (em cima da geladeira) em MDF Freijó Guararapes 18mm — portas de abrir lisas, frentes mimetizadas, dobradiças com amortecimento.\nIluminação em LED.\nPuxador cava na madeira.\n\nGABINETE INFERIOR:\n1500x720x650mm + 630x720x650mm em MDF Gianduia Trama Duratex 18mm — composição com gavetas (4 frentes em coluna), portas de abrir, nicho para lava-louças e espaçamento para máquina de lavar.\nPuxador cava na madeira.\n\nILHA CENTRAL:\n2150x670x720mm em MDF Gianduia 18mm com 2 gavetas e 1 gavetão, fechamento para forno embutido.\nRevestimento frontal.\nNichos decorativos na lateral.\nInterior em MDF Branco TX 15mm.\nPuxador cava na madeira.\n\nARMÁRIO BAR:\n100x720x400mm (inferior) em MDF Freijó Guararapes 18mm.\nArmário com portas de abrir.\nPrateleira interna.\nPuxador cava na madeira.\n\nBancada e ilha em Granito Preto São Gabriel.\nFundos em MDF Gianduia/Freijó 06mm.\nInterior em MDF Branco TX 15mm."},
      "Cozinha — Nicho e Cristaleira Suspensa":{newName:"Cozinha — Prateleiras",newDesc:"Conjunto de prateleiras superiores + cristaleira suspensa.\n\nPRATELEIRAS SUPERIORES:\n3 prateleiras em MDF Freijó Guararapes 18mm — 1000x40x300mm cada.\nFixação oculta por grapas.\n\nCRISTALEIRA SUSPENSA:\nMódulo suspenso 700x1140x300mm em MDF Gianduia Trama Duratex 18mm.\nPortas com vidro temperado incolor e moldura em MDF.\nFundo revestido em espelho.\nPrateleiras internas em vidro temperado.\nIluminação em LED."},
      "Cozinha — Prateleiras":{newName:"Cozinha — Prateleiras",newDesc:"Conjunto de prateleiras superiores + cristaleira suspensa.\n\nPRATELEIRAS SUPERIORES:\n3 prateleiras em MDF Freijó Guararapes 18mm — 1000x40x300mm cada.\nFixação oculta por grapas.\n\nCRISTALEIRA SUSPENSA:\nMódulo suspenso 700x1140x300mm em MDF Gianduia Trama Duratex 18mm.\nPortas com vidro temperado incolor e moldura em MDF.\nFundo revestido em espelho.\nPrateleiras internas em vidro temperado.\nIluminação em LED."},
      "Varanda Gourmet":{newName:"Varanda Gourmet",newDesc:"Marcenaria completa para varanda gourmet integrada à cozinha.\n\nARMÁRIOS INFERIORES:\nGabinete inferior 1700x700x650mm em MDF Gianduia Trama Duratex 18mm.\nComposição: 4 portas de giro + 2 gavetões + portas superiores ventiladas e fechamento para churrasqueira embutida.\nFrentes mimetizadas com puxador slim.\nFerragens com amortecimento.\n\nTORRE:\nColuna 850x2200x400mm em MDF Gianduia 18mm para utensílios e armazenagem.\nPortas de abrir lisas + prateleiras internas.\nInterior em MDF Branco TX 15mm.\n\nCACHEPOT:\n2 unidades 600x900x350mm em MDF Freijó Guararapes 18mm com pés em metalon (pintura eletrostática preto fosco).\n\nBANCADA:\nBancada em Granito Preto São Gabriel sobre o gabinete inferior.\nRecorte para churrasqueira embutida (compra cliente)."},
      "Sala de Estar — Painel TV e Rack":{newName:"Sala de Estar — Painel TV e Rack",newDesc:"PAINEL DE TV:\nPainel de TV Frisado em L 3800x2450x40mm em MDF Freijó Guararapes 18mm na parede principal da sala.\nMontagem piso-teto com recorte central para TV e cabeamento embutido.\nIluminação indireta em LED contornando o painel.\n\nPRATELEIRA SUPERIOR:\n6250x350x40mm em MDF Freijó Guararapes 18mm com fixação oculta.\n\nRACK INFERIOR FLUTUANTE:\nRack suspenso 1900x400x350mm em MDF Gianduia Trama Duratex 18mm.\n2 gavetas com frente passante (sem puxador aparente).\nIluminação LED indireta sob o rack (efeito flutuante).\nFundo em MDF Gianduia 06mm.\nFerragens com amortecimento."},
      "Quarto Compacto — Costura e Visitas":{newName:"Quarto — Costura e Visitas",newDesc:"Quarto multifuncional para costura e hospedagem.\n\nCAMA FUNCIONAL SOLTEIRO:\nCama de solteiro 850x350x1950mm em MDF Freijó Guararapes 18mm.\n3 gavetões inferiores para armazenagem com corrediças telescópicas.\nFundo em MDF Freijó 06mm.\n\nBAÚ CABECEIRA:\nBaú/painel cabeceira 850x800x500mm em MDF Freijó Guararapes 18mm com tampa basculante + pistão a gás e 2 gavetas.\n\nBANCADA DE COSTURA:\nBancada de trabalho 1870x400x500mm em MDF Freijó Guararapes 18mm.\nArmário embaixo da bancada com 1 porta de giro e prateleira interna — 600x780x600mm.\nPrateleiras abertas superiores em MDF Freijó 18mm — fixação oculta por grapas com perfil de LED embutido por baixo.\n3 prateleiras em L de 1230x40x300mm + 600x40x500mm e 1 de 600x40x500mm.\n\nARMÁRIO SUPERIOR:\nArmário com 1 porta de abrir e prateleira interna — 850x1150x320mm.\n\nGUARDA-ROUPA:\nArmário 1000x2550x600mm em MDF Gianduia Trama Duratex 18mm.\nDivisão clara entre área de roupas (cabideiro + gavetas internas + sapateira inferior) e área de costura (prateleiras + gavetas para acessórios).\nPrateleiras superiores para uso menos frequente.\nFundo em MDF Gianduia 06mm.\nInterior em MDF Branco TX 15mm.\nPuxador slim em alumínio."},
      "Quarto — Costura e Visitas":{newName:"Quarto — Costura e Visitas",newDesc:"Quarto multifuncional para costura e hospedagem.\n\nCAMA FUNCIONAL SOLTEIRO:\nCama de solteiro 850x350x1950mm em MDF Freijó Guararapes 18mm.\n3 gavetões inferiores para armazenagem com corrediças telescópicas.\nFundo em MDF Freijó 06mm.\n\nBAÚ CABECEIRA:\nBaú/painel cabeceira 850x800x500mm em MDF Freijó Guararapes 18mm com tampa basculante + pistão a gás e 2 gavetas.\n\nBANCADA DE COSTURA:\nBancada de trabalho 1870x400x500mm em MDF Freijó Guararapes 18mm.\nArmário embaixo da bancada com 1 porta de giro e prateleira interna — 600x780x600mm.\nPrateleiras abertas superiores em MDF Freijó 18mm — fixação oculta por grapas com perfil de LED embutido por baixo.\n3 prateleiras em L de 1230x40x300mm + 600x40x500mm e 1 de 600x40x500mm.\n\nARMÁRIO SUPERIOR:\nArmário com 1 porta de abrir e prateleira interna — 850x1150x320mm.\n\nGUARDA-ROUPA:\nArmário 1000x2550x600mm em MDF Gianduia Trama Duratex 18mm.\nDivisão clara entre área de roupas (cabideiro + gavetas internas + sapateira inferior) e área de costura (prateleiras + gavetas para acessórios).\nPrateleiras superiores para uso menos frequente.\nFundo em MDF Gianduia 06mm.\nInterior em MDF Branco TX 15mm.\nPuxador slim em alumínio."},
      "Quarto da Filha":{newName:"Quarto da Filha",newDesc:"Quarto feminino contemporâneo (casal).\n\nCAMA CASAL COM GAVETAS:\nCama de casal 1430x1930x350mm em MDF Freijó Guararapes 18mm.\nGavetões frontais (2 frentes em coluna).\n4 gavetas, 2 em cada lado.\n\nCABECEIRA EM MADEIRA:\nCabeceira 2800x1250x40mm em MDF Freijó Guararapes 18mm com perfil de LED embutido por trás (iluminação indireta).\nFixação em parede.\n\nCRIADOS-MUDOS (2 unidades):\nCriado-mudo 650x550x450mm em MDF Freijó Guararapes 18mm (estrutura) com frentes de gaveta em MDF Gianduia Trama Duratex 18mm.\n2 gavetas com frente passante.\nCorrediças telescópicas com amortecimento.\n\nGUARDA-ROUPA / CLOSET (3 portas de correr):\nArmário 2900x2460x600mm em MDF Gianduia Trama Duratex 18mm.\n3 portas de correr — 1 central espelhada + 2 laterais em acabamento Gianduia.\nTrilho superior embutido (sistema slim).\n\nINTERIOR DO CLOSET (em MDF Branco TX 15mm):\n3 cabideiros em alturas diferentes (0,95m / 1,05m / 1,20m) em tubo oblongo cromado.\nCabideiro lateral para roupas longas.\nGavetas internas — coluna esquerda (5 gavetas), coluna central (4 sapateiras) e coluna direita (4 gavetas).\nPrateleiras superiores para caixas e malas (alturas 0,25 / 0,30 / 0,57m).\nSapateira inferior com prateleiras.\nFundo em MDF Branco TX.\n\nPAINEL DE TV:\nPainel TV 1150x2460x40mm em MDF Freijó Guararapes 18mm — recorte para TV com cabeamento embutido.\nPrateleira horizontal 2050x40x250mm em MDF Gianduia Trama Duratex 18mm com fixação oculta por grapas."},
      "Suíte Casal":{newName:"Suíte Casal",newDesc:"Suíte master com cama queen, cabeceira iluminada, criados-mudos com rodízios e armário com TV embutida.\n\nCAMA QUEEN COM GAVETAS:\nCama queen 1600x400x2000mm em MDF Freijó Guararapes 18mm.\nGavetões frontais (2 frentes em coluna).\n2 gavetões e 1 gaveta menor de cada lado.\nFundo em MDF Freijó 06mm.\n\nCABECEIRA EM FREIJÓ:\nPainel cabeceira 2800x1250x40mm em MDF Freijó Guararapes 18mm — fixação em parede com perfil de LED embutido na borda superior (iluminação indireta).\nPreparação para 2 arandelas articuladas fixadas na cabeceira (luminárias compra cliente).\n\nCRIADOS-MUDOS (2 unidades):\nCriado-mudo 530x400x500mm em MDF Freijó Guararapes 18mm com rodízios escondidos.\n2 gavetas + 1 nicho aberto inferior.\nCorrediças telescópicas com amortecimento.\nFrente passante com puxador cava.\n\nARMÁRIO 4 PORTAS DE CORRER COM TV:\nArmário planejado 3800x2560x600mm em MDF Gianduia Trama Duratex 18mm.\n4 portas de correr em Reflecta Bronze (efeito espelhado bronze) com perfil slim Bronze.\nTrilho superior embutido (sistema slim) — abertura suave com amortecimento.\nRecorte para TV fixada na 3ª porta (alinhada à cama) com cabeamento embutido.\n\nINTERIOR DO ARMÁRIO (em MDF Branco TX 15mm):\nCabideiros em diferentes alturas (1,05m e 1,95m) em tubo oblongo cromado para roupas curtas e longas.\nColuna esquerda — gaveteiro com 4 gavetas + sapateira inferior com 3 prateleiras.\nColunas centrais — cabideiros + gaveteiro com 5 gavetas (acessórios e roupas dobradas).\nColuna direita — gaveteiro com 3 gavetas + sapateira inferior + prateleiras superiores.\nPrateleiras superiores corridas para caixas e malas.\nFundo em MDF Gianduia 06mm.\n\nFERRAGENS: corrediças telescópicas, trilho de correr embutido com amortecimento."},
      "Banheiro Suíte":{newName:"Banheiro Suíte",newDesc:"Banheiro da suíte com gabinete suspenso e espelheira planejada.\n\nGABINETE INFERIOR SUSPENSO:\nGabinete suspenso 800x700x500mm em MDF Gianduia.\n1 basculante e 1 gaveta com corrediças invisíveis e puxador cava.\nRecorte para cuba de sobrepor (cuba e torneira compra cliente).\nTampo em porcelanato/granito (à definir com cliente).\n\nESPELHEIRA SUSPENSA:\nArmário espelheira 800x900x150mm em MDF Gianduia com 3 portas espelhadas.\nPrateleiras internas em MDF Branco TX para armazenagem de itens de higiene.\nDobradiças em inox com amortecimento.\nFita de LED embutida na borda inferior (iluminação direta sobre a bancada).\nO LED se estende embaixo da prateleira também.\n\nPRATELEIRA DE APOIO:\nPrateleira lateral 600x400x150mm em MDF Branco TX com fixação oculta por grapas para apoio de plantas e decoração.\n\nFundo em MDF Branco TX.\nPuxador cava na madeira."},
      "Banheiro Social":{newName:"Banheiro Social",newDesc:"Banheiro social com gabinete suspenso e espelheira planejada.\n\nGABINETE INFERIOR SUSPENSO:\nGabinete suspenso 800x700x500mm em MDF Gianduia.\n1 basculante e 1 gaveta com corrediças invisíveis e puxador cava.\nRecorte para cuba de sobrepor (cuba e torneira compra cliente).\nTampo em porcelanato/granito (à definir com cliente).\n\nESPELHEIRA SUSPENSA:\nArmário espelheira 800x900x150mm em MDF Gianduia com 3 portas espelhadas.\nPrateleiras internas em MDF Branco TX para armazenagem de itens de higiene.\nDobradiças em inox com amortecimento.\nFita de LED embutida na borda inferior (iluminação direta sobre a bancada).\nO LED se estende embaixo da prateleira também.\n\nPRATELEIRA DE APOIO:\nPrateleira lateral 600x400x150mm em MDF Branco TX com fixação oculta por grapas para apoio de plantas e decoração.\n\nFundo em MDF Branco TX.\nPuxador cava na madeira."},
    };
    let atualizados=0;
  ...
  const PgDRE=()=>{
    ...
    const pedAno=pedidos.filter(p=>p.data?.endsWith(anoStr)&&p.status!=="cancelado");
    ...
    // Categorias de despesas operacionais para o ano
    const byCat={};financeiro.filter(filtroDespesas).forEach(f=>{const pags=f.parcelas.filter(p=>p.venc?.startsWith(anoStr));if(!pags.length)return;const v=pags.reduce((s,p)=>s+p.valor,0);const c=f.categoria||"Outros";byCat[c]=(byCat[c]||0)+v;});
