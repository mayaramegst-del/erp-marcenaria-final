...
export default function ERP(){
  ...
  const importarOrcSodero=()=>{
    const ambsBase=[
      {nome:"Cozinha",desc:"Cozinha integrada com ilha central.\nArmários superiores 4200x700x350mm em MDF Freijó Guararapes 18mm — portas de abrir lisas, frentes mimetizadas, dobradiças com amortecimento.\nGabinete inferior 4200x900x600mm em MDF Gianduia Trama Duratex 18mm — composição com gavetões (3 frentes em coluna), portas de abrir, nicho ventilado para forno embutido e nicho para lava-louças.\nFrente para cooktop integrado à bancada.\nTorre coluna geladeira 800x2700x650mm em MDF Gianduia 18mm.\nIlha central 2400x900x900mm em MDF Gianduia 18mm com gavetões frontais.\nBancada e ilha em Granito Preto São Gabriel.\nFundos em MDF Gianduia/Freijó 06mm.\nInterior em MDF Branco TX 15mm.\nIluminação LED sob armários superiores.\nPuxador slim em alumínio."},
      {nome:"Cozinha — Nicho e Cristaleira Suspensa",desc:"Conjunto de nichos sob bancada (devido infra do gás) + cristaleira suspensa + prateleiras laterais formando sanca.\n\nNICHO INFERIOR (sob bancada):\nNicho aberto com prateleiras 2200x800x350mm em MDF Gianduia Trama Duratex 18mm.\n\nCRISTALEIRA SUSPENSA:\nMódulo suspenso 1200x900x350mm em MDF Gianduia Trama Duratex 18mm.\nPortas com vidro temperado incolor e armação em perfil slim de alumínio.\nFundo revestido em espelho.\nPrateleiras internas em vidro temperado 8mm.\nIluminação LED Elegance.\n\nPRATELEIRAS LATERAIS / SANCA:\nPrateleiras horizontais 3500x40x300mm em MDF Freijó Guararapes 18mm com fixação oculta por grapas — passam por cima da cristaleira e formam a sanca de transição para a sala de TV.\nIluminação LED indireta embutida na sanca."},
      {nome:"Varanda Gourmet",desc:"Marcenaria completa para varanda gourmet integrada à cozinha.\n\nARMÁRIOS INFERIORES:\nGabinete inferior 3200x900x600mm em MDF Gianduia Trama Duratex 18mm.\nComposição: gavetões (4 frentes em coluna) + portas de abrir + nicho ventilado para churrasqueira embutida.\nFrentes mimetizadas com puxador slim.\nFerragens com amortecimento.\n\nTORRE PISO-TETO:\nColuna 800x2700x600mm em MDF Gianduia 18mm para utensílios e armazenagem.\nPortas de abrir lisas + prateleiras internas ajustáveis (pino oculto) + gavetões inferiores.\nFundo em MDF Gianduia 06mm.\nInterior em MDF Branco TX 15mm.\n\nBANCADA:\nBancada em Granito Preto São Gabriel sobre o gabinete inferior.\nRecorte para churrasqueira embutida (compra cliente)."},
      {nome:"Sala de Estar — Painel TV e Rack",desc:"Painel de TV 3200x2700x40mm em MDF Freijó Guararapes 18mm na parede principal da sala.\nMontagem piso-teto com recorte central para TV e cabeamento embutido.\nMoldura com iluminação indireta LED contornando o painel (parede destaque azul petróleo de fundo — pintura de obra, não inclui marcenaria).\n\nRACK INFERIOR FLUTUANTE:\nRack suspenso 2800x350x450mm em MDF Gianduia Trama Duratex 18mm.\n3 portas de abrir com frente passante (sem puxador aparente).\nIluminação LED indireta sob o rack (efeito flutuante).\nFundo em MDF Gianduia 06mm.\nFerragens com amortecimento."},
