...
export default function ERP(){
  ...
  const importarOrcRodrigo=()=>{
    ...
    const ambs=[
      {id:uid(),nome:"Cozinha — Armários Superiores",desc:"Armários aéreos em MDF (cor a definir). Largura total aprox. 540cm divididos em módulos de 89 + 101 + 101 + 101 + 72 + 76cm. Altura 59cm. 12 portas de abrir (passantes, sem puxador aparente). Espaço reservado para coifa e nicho central de 160cm (para forno/micro/cafeteira) com tomadas embutidas. Iluminação LED inferior nos armários sobre a bancada. Cabideiro lateral em metalon (76cm).",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Cozinha — Balcão Inferior e Bancada",desc:"Balcão inferior em MDF (cor a definir) sobre sapata 15cm. Largura total 305cm + extensão 381cm. Módulos: 53 + 63 + 50 + 62 + 69cm (com cuba sob bancada) + 73cm de torre lateral. Altura 70cm. Composição interna: gavetões (3 frentes), portas de abrir e nichos para forno embutido, máquina de lavar/secar e cooktop. Bancada em pedra (quartzo ou similar) recobrindo toda a extensão. Vão sem sapata reservado para máquina/lava-louças. Frentes mimetizadas (mesma altura) inclusive para porta de passagem.",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Cozinha — Painel Ripado e Cabideiro",desc:"Painel ripado vertical em MDF amadeirado na lateral da cozinha (próximo à geladeira/lavanderia), seguindo \"na vira\" para a parede adjacente. Cabideiro horizontal em metalon preto/dourado fixado sobre o painel ripado para acessórios e utensílios. Acabamento estendendo-se até o teto.",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Lavanderia — Coluna Integrada",desc:"Coluna em MDF (mesmo padrão da cozinha) integrada ao layout da cozinha, com profundidade 24cm e largura 79cm. Espaço para máquina de lavar com portas de abrir superiores (24cm) e inferiores. Ventilação cruzada nas portas inferiores. Frente passante mimetizada com o restante da bancada.",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Sala TV — Painel Ripado com Balcão de Pedra (Vista 2)",desc:"Painel ripado vertical em MDF amadeirado sobre parede pintada verde escuro. Largura total 425cm. Balcão de pedra (quartzo ou granito) com 33cm de altura sustentado em todo o comprimento. Embaixo do balcão: módulos de gavetas e portas de abrir nas medidas 80 + 80 + 80 + 40 + 70 + 70cm (4 portas abrir + 2 gavetões + 2 gavetas internas). Altura interna do balcão 70cm + 5cm de moldura superior. Painel ripado vira para a parede adjacente (continuidade do acabamento).",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Sala TV — Painel Ripado com TV (Vista 3)",desc:"Painel ripado vertical em MDF amadeirado, largura total 382cm × altura 220cm (com vira de 15cm). Recorte central de 142cm × 186cm para encaixe de TV de 65/75\" com cabeamento embutido. Lateral direita com ripado 77 + 77 + 77cm. Balcão de pedra inferior 235cm × 50cm com 5 portas de abrir + 2 gavetas (frentes passantes sem puxador).",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Quarto 01 — Roupeiro em L",desc:"Roupeiro em \"L\" em MDF (cor a definir). Lateral 1: 141cm × 214cm altura × 65cm profundidade. Lateral 2 (frente): 76cm × 214cm altura × 50cm profundidade. Composição: Vista 1 — 2 portas de abrir superiores (63 + 72cm) + gaveteiro inferior com 5 gavetas (32 + 32 + 32cm) e 2 prateleiras finais. Vista 2 — 2 portas de correr (164cm + 50cm) revestidas com porta de espelho na de 50cm. Interior: 6 prateleiras ajustáveis (28cm cada) na coluna estreita + área de cabideiro (122cm) + sapateira inferior. Pino oculto, puxador cava.",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Quarto 01 — Bancada de Estudo / Penteadeira com Painel",desc:"Bancada flutuante em MDF (cor a definir) com tampo 185cm × 50cm profundidade. Gaveteiro lateral acoplado com 4 gavetas (130cm largura × 75cm altura). Painel suspenso acima da bancada com 2 prateleiras (40cm e 92cm) com recorte para fita de LED Elegance embutida (acionamento na marcenaria). Frente das gavetas passante (sem puxador).",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Quarto 01 — Cabeceira e Mesa de Cabeceira",desc:"Cabeceira estofada/marcenaria 178cm largura × 115cm altura, com 2 gavetas internas centrais (50cm × 44cm) para guardar pertences. Mesa de cabeceira flutuante com rodízios em MDF: 40cm × 50cm × 44cm altura, 2 gavetas frontais. Espelho oval lateral (decoração — não inclui marcenaria).",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Suíte Casal — Painel Ripado com TV",desc:"Painel ripado vertical em MDF amadeirado, largura 262cm × altura 248cm (com vira superior 25cm). Recorte central para TV com cabeamento embutido. Lateral direita com 3 prateleiras de 39cm de profundidade (alturas 22 + 22 + 18cm) para decoração. Acabamento estendendo até o teto.",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Suíte Casal — Armário sob Janela (Bancada)",desc:"Bancada/armário sob janela em MDF (cor a definir). 247cm largura × 40cm profundidade × 80cm altura (com 14cm para gavetas). Composição: 2 gavetas superiores (40 + 40cm) + 4 portas de abrir (65 + 65 + 65 + 33cm) na parte inferior. Tampo 247cm × 40cm para uso como bancada/aparador. Frentes passantes sem puxador.",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Suíte Casal — Cabeceira e Mesas de Cabeceira",desc:"Cabeceira estofada/marcenaria 270cm largura × 115cm altura (largura total do quarto), com 2 gavetas internas (50cm × 44cm). 2 mesas de cabeceira flutuantes com rodízios em MDF (40cm × 50cm × 44cm altura, 2 gavetas cada). Frente passante sem puxador.",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Suíte Casal — Roupeiro em L com Nicho Vazado",desc:"Roupeiro em \"L\" em MDF (cor a definir). Vista 1: 152cm × 276cm altura (50 + 37 + 65cm em profundidade variável). Composição — 2 portas superiores de abrir + nicho vazado central (decoração com LED) + 5 gavetas inferiores. Vista 2: 245cm × 276cm altura × 50cm profundidade, com 3 portas de correr (frente lisa). Interior: cabideiros (4 colunas) + 5 prateleiras (29 + 30 + 30 + 29cm) + 5 gavetas (35 + 32 + 32 + 32 + 32 + 32cm em coluna) com puxador cava. Pino oculto regulável.",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Banho Social — Gabinete e Armário Aéreo com Espelho",desc:"Gabinete inferior em MDF: 145cm largura × 49cm altura × 49cm profundidade, com 2 portas de abrir e cuba semi-embutida (75cm × 25cm reservados). Bancada em pedra. Armário aéreo: 145cm × 101cm altura × 32cm profundidade. Composição: 2 portas de abrir laterais (63cm) com 3 prateleiras internas (30cm cada) + porta central em espelho orgânico (78cm) com puxador discreto. Faixa de 44cm acima da bancada para azulejos/decoração.",insumos:[],vi:0,valorTotal:0},
      {id:uid(),nome:"Banho Suíte — Gabinete e Armário Aéreo com Espelho",desc:"Gabinete inferior em MDF: 164cm largura × 45cm altura × 60cm profundidade, com 2 portas de abrir e cuba semi-embutida (78cm × 25cm reservados). Bancada em pedra. Armário aéreo: 165cm × 101cm altura × 32cm profundidade. Composição: 2 portas de abrir laterais (76cm) com 3 prateleiras internas (30cm cada) + porta central em espelho orgânico (84cm) com puxador discreto. Faixa de 44cm acima da bancada para azulejos/decoração.",insumos:[],vi:0,valorTotal:0},
    ];
    const oid=uid();
    const num=`ORC-${String(orcamentos.length+1).padStart(4,"0")}`;
    const o={id:oid,num,clienteId:cliId,data:hoje(),status:"rascunho",ambientes:ambs,garantia:empresa.garantia||GARANTIA,garantiaE:false,pagamento:empresa.pagamento||PAGAMENTO,pagamentoE:false,markup:MARKUP,desconto:0,vendedorId:"",percNF:0,especificacoes:empresa.especificacoes||ESPECIFICACOES,especificacoesE:false,validade:mesVigente(),prazoEntrega:empresa.prazoExecucao||""};
