...
export default function ERP(){
  ...
  const importarOrcSodero=()=>{
    const ambsBase=[
      ...
      {nome:"Quarto Compacto — Costura e Visitas",desc:"Quarto multifuncional para costura e hospedagem.\n\nCAMA FUNCIONAL SOLTEIRO:\nCama de solteiro 900x400x2000mm em MDF Freijó Guararapes 18mm.\n3 gavetões inferiores para armazenagem com corrediças telescópicas 30kg.\nFundo em MDF Freijó 06mm.\n\nBAÚ CABECEIRA:\nBaú/painel cabeceira 1100x900x350mm em MDF Freijó Guararapes 18mm com tampa basculante + pistão a gás.\n\nBANCADA DE COSTURA:\nBancada de trabalho 2200x750x500mm em MDF Freijó Guararapes 18mm.\nGaveteiro acoplado com 3 gavetas (frente passante).\nPrateleiras abertas superiores 2200x40x250mm em MDF Freijó 18mm — fixação oculta por grapas com perfil de LED embutido por baixo.\n\nARMÁRIO PISO-TETO:\nArmário 1800x2700x600mm em MDF Gianduia Trama Duratex 18mm.\nDivisão clara entre área de roupas (cabideiro + gavetas internas + sapateira inferior) e área de costura (prateleiras + gavetas para acessórios).\nPrateleiras superiores para uso menos frequente.\nFundo em MDF Gianduia 06mm.\nInterior em MDF Branco TX 15mm.\nPuxador slim em alumínio."},
      {nome:"Quarto da Filha",desc:"Quarto feminino contemporâneo.\n\nCABECEIRA EM MADEIRA:\nCabeceira 2400x1200x40mm em MDF Freijó Guararapes 18mm com perfil de LED embutido por trás (iluminação indireta).\nFixação em parede.\n\nCRIADOS-MUDOS (2 unidades):\nCriado-mudo 500x500x400mm em MDF Freijó Guararapes 18mm (estrutura) com frentes de gaveta em MDF Gianduia Trama Duratex 18mm.\n2 gavetas com frente passante.\nCorrediças telescópicas com amortecimento.\n\nGUARDA-ROUPA / CLOSET (3 portas de correr):\nArmário 3000x2700x600mm em MDF Gianduia Trama Duratex 18mm.\n3 portas de correr — 1 central espelhada + 2 laterais em acabamento Gianduia.\nTrilho superior embutido (sistema slim).\n\nINTERIOR DO CLOSET (em MDF Branco TX 15mm):\n3 cabideiros em alturas diferentes (0,95m / 1,05m / 1,20m) em tubo oblongo cromado.\nCabideiro lateral 1,95m para roupas longas.\nGavetas internas — coluna esquerda (5 gavetas), coluna central (4 gavetas pequenas para acessórios) e coluna direita (4 gavetas).\nPrateleiras superiores para caixas e malas (alturas 0,25 / 0,30 / 0,57m).\nSapateira inferior com prateleiras.\nFundo em MDF Gianduia 06mm.\n\nPAINEL DE TV:\nPainel TV 1400x2400x40mm em MDF Freijó Guararapes 18mm — recorte para TV com cabeamento embutido.\nPrateleira horizontal 1400x40x250mm em MDF Gianduia Trama Duratex 18mm com fixação oculta por grapas."},
      {nome:"Suíte Casal",desc:"Suíte master com cama queen, cabeceira iluminada, criados-mudos integrados e armário com TV embutida.\n\nCAMA QUEEN COM BAÚ:\nCama queen 1600x400x2000mm em MDF Freijó Guararapes 18mm.\nBaú inferior com gavetões frontais (2 frentes em coluna) com corrediças telescópicas 30kg para armazenagem.\nFundo em MDF Freijó 06mm.\n\nCABECEIRA EM FREIJÓ:\nPainel cabeceira 3200x1200x40mm em MDF Freijó Guararapes 18mm — fixação em parede com perfil de LED embutido na borda superior (iluminação indireta).\nPreparação para 2 arandelas articuladas fixadas na cabeceira (luminárias compra cliente).\n\nCRIADOS-MUDOS INTEGRADOS (2 unidades):\nCriado-mudo 500x500x400mm em MDF Freijó Guararapes 18mm com tampo integrado à linha da cabeceira.\n1 gaveta + 1 nicho aberto inferior.\nCorrediças telescópicas com amortecimento.\nFrente passante (sem puxador aparente).\n\nARMÁRIO 4 PORTAS DE CORRER COM TV:\nArmário planejado 3000x2700x600mm em MDF Gianduia Trama Duratex 18mm.\n4 portas de correr em Reflecta Bronze (efeito espelhado bronze) com perfil slim em alumínio.\nTrilho superior embutido (sistema slim) — abertura suave com amortecimento.\nRecorte para TV fixada na 3ª porta (alinhada à cama) com cabeamento embutido.\n\nINTERIOR DO ARMÁRIO (em MDF Branco TX 15mm):\nCabideiros em diferentes alturas (1,05m e 1,95m) em tubo oblongo cromado para roupas curtas e longas.\nColuna esquerda — gaveteiro com 4 gavetas + sapateira inferior com 3 prateleiras.\nColunas centrais — cabideiros + gaveteiro com 5 gavetas (acessórios e roupas dobradas).\nColuna direita — gaveteiro com 3 gavetas + sapateira inferior + prateleiras superiores.\nPrateleiras superiores corridas para caixas e malas.\nFundo em MDF Gianduia 06mm.\n\nFERRAGENS: corrediças telescópicas Hafele 30kg, trilho de correr embutido com amortecimento."},
      {nome:"Banheiro Suíte",desc:"Banheiro da suíte com gabinete suspenso e espelheira planejada.\n\nGABINETE INFERIOR SUSPENSO:\nGabinete suspenso 1000x500x500mm em MDF Branco TX 18mm.\n2 gavetões frontais com corrediças telescópicas 30kg e frente passante.\nRecorte para cuba de sobrepor (cuba e torneira compra cliente).\nTampo em porcelanato/granito (à definir com cliente).\n\nESPELHEIRA SUSPENSA:\nArmário espelheira 1200x900x150mm em MDF Branco TX 18mm com 3 portas espelhadas.\nPrateleiras internas em vidro temperado 6mm para armazenagem de itens de higiene.\nDobradiças com amortecimento.\nFita de LED embutida na borda inferior (iluminação direta sobre a bancada).\n\nPRATELEIRA DE APOIO:\nPrateleira lateral 600x40x200mm em MDF Branco TX 18mm com fixação oculta por grapas para apoio de plantas e decoração.\n\nFundo em MDF Branco TX 06mm.\nPuxador embutido tipo cava (sem ferragem aparente)."},
    ];
